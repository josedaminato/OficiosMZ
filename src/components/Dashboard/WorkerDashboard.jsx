            ...
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-blue-700">
                  <p>
                    Aquí podrás gestionar tus solicitudes de trabajo, ver tus ingresos y mantener tu perfil actualizado. 
                    Recuerda mantener tu disponibilidad actualizada para recibir más solicitudes.
                  </p>
                </div>
              </div>
            </div>
